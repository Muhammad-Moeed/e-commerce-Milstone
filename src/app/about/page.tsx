  ...
  return (
    ...
    <div>
      ...
      <section className="py-16 bg-gray-100 text-[#000] animate__animated animate__fadeIn">
       ...
       {/* Our Values */}
     <section className="py-16   bg-gradient-to-r from-blue-800 to-black shadow-lg shadow-lg animate__animated animate__fadeInDown">
        ...
        <h2 className="text-4xl font-bold text-white mb-10 animate__animated animate__fadeInDown">Our Values</h2>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 bg-white shadow-md rounded-lg  bg-black text-white shadow-lg shadow-lg">
              <h3 className="text-xl font-bold text-black mb-4 animate__animated animate__fadeIn">Quality</h3>
              <p className="text-gray-600">
                We are committed to offering the highest quality products that you can trust.
               </p>
             </div>
            <div className="p-6 bg-white shadow-md rounded-lg    bg-black text-white shadow-lg shadow-lg">
              <h3 className="text-xl font-bold text-black mb-4">Integrity</h3>
              <p className="text-gray-600">
