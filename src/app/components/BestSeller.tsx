  ...
  return (
    <section className="py-16 ">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 text-blue-950">Best Sellers</h2>
          ...
          {bestSellerItems.map((item) => (
            <div key={item.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <Link href={item.link} className="block mt-6 bg-black text-white py-2 px-4 rounded-lg hover:bg-white hover:text-black transition">
                  View Product
                </Link>
              </div>
            </div>
