    ...
    <footer className=" bg-blue-950 shadow-lg animate__animated animate__slideInLeft text-white py-12     ">
      <div className="container mx-auto px-16">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-3xl font-bold mb-4">Qadri Store</h3>
            <p className="text-[#C5A94] ">
            Qadri Store is a local retail establishment offering a variety of products, catering to the needs of its community
            </p>
          </div>
  ...
  {[FaFacebookF, FaInstagram, FaTwitter, FaLinkedinIn].map((Icon, idx) => (
    ...
    />
        ...
        <div className="text-center mt-8 text-sm">
          <p className="text-green-500">&copy; {new Date().getFullYear()} Qadir Store. All rights reserved.</p>
          <a className="text-green-500">&copy; {new Date().getFullYear()} Muhammad Moeed</a>
        </div> 
      </div>
    </footer>
  );
